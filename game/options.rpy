...
define config.name = _("Beginners Guide to Good(?) Ghosthunting")
...
define build.name = "BeginnersGuideToGhosthunting"
...
define config.save_directory = "BeginnersGuideToGhosthunting-1632961181"
